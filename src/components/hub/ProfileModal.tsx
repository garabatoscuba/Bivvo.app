    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg p-0 gap-0 overflow-hidden">
        <DialogHeader className="px-6 py-4 border-b border-border">
          ...
          <DialogDescription>Administra tu perfil y seguridad personal.</DialogDescription>
        </DialogHeader>
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        <Label htmlFor="pm-fullName">Nombre completo</Label>
        <Input id="pm-fullName" value={fullName} onChange={e => setFullName(e.target.value)} />
      </div>
      <div className="space-y-2">
        <Label htmlFor="pm-email">Email</Label>
        <Input id="pm-email" value={profile?.email || ''} disabled className="opacity-60" />
      </div>
      <div className="space-y-2">
        <Label htmlFor="pm-displayName">Confirmar nombre para mostrar</Label>
        <Input
          id="pm-displayName"
          value={displayName}
      ...
      <div className="space-y-2">
        ...
        <Input id="pm-phone" value={phone} onChange={e => setPhone(e.target.value)} placeholder="+53" />
      </div>
...
function SecuritySection() {
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        <Label htmlFor="pm-newPassword">Nueva contraseña</Label>
      ...
      <div className="space-y-2">
        <Label htmlFor="pm-confirmPassword">Confirmar contraseña</Label>
        <div className="relative">
          <Input
            id="pm-confirmPassword"
