      ...
      >
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="relative w-[34px] h-[34px] hidden sm:inline-flex items-center justify-center rounded-[var(--te-r-sm)] bg-transparent border-0 cursor-pointer transition-colors hover:bg-[var(--bg-surface)]"
          ...
          <button
            ...
            title="Escanear"
            className="w-[34px] h-[34px] hidden sm:inline-flex items-center justify-center rounded-[var(--te-r-sm)] bg-transparent border-0 cursor-pointer transition-colors text-[var(--te-text-tertiary)] hover:bg-[var(--bg-surface)] hover:text-[var(--te-text-primary)]"
          >
